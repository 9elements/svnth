...
fn run_both() -> Result<(), Box<dyn Error>> {
    let mut input = String::new();
    let mut saw_mod = 0.02;
...
//    let saw_mod_state = Mutex::new(0.02);
    ...
    let callback = move |pa::OutputStreamCallbackArgs { buffer, frames, .. }| {
        ...
        for _ in 0..frames {
            ...
            let mut sm = saw_mod_state.read().unwrap();
...
fn run_pa() -> Result<(), Box<dyn Error>> {
    let mut input = String::new();
